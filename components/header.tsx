...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-secondary/20 bg-gradient-to-r from-primary via-primary/95 to-primary/90 backdrop-blur-sm">
      <div className="container flex h-16 items-center justify-start px-4 md:px-6">
        <div className="flex items-center space-x-2">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">Nexus Shift</span>
          </Link>
        </div>
        ...
        <div className="ml-auto flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-4">
            <Button className="hidden md:inline-flex bg-secondary hover:bg-secondary/90 text-primary" asChild>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gradient-to-r from-primary via-primary/95 to-secondary/20 border-t border-secondary/20">
          <div className="container px-4 py-4 space-y-4">
            ...
            <Button className="w-full bg-secondary hover:bg-secondary/90 text-primary mt-4" asChild>
