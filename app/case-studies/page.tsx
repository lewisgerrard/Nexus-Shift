    ...
    <div className="min-h-screen bg-white dark:bg-background-dark">
      ...
      <div className="container mx-auto py-12 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-primary/5 via-secondary/10 to-primary/3 dark:bg-surface-dark">
            <CardHeader>
              <div className="bg-gradient-to-br from-primary/20 to-secondary/30 rounded-lg h-48 flex items-center justify-center mb-4">
                <div className="text-center text-white">
                  <div className="text-4xl font-bold mb-2">E-Commerce</div>
                  <div className="text-sm opacity-80">Platform Redesign</div>
                </div>
              </div>
              <Badge variant="outline" className="w-fit mb-2">
                E-Commerce
              </Badge>
              <CardTitle className="dark:text-text-dark">Retail Platform Modernization</CardTitle>
              <CardDescription className="dark:text-text-dark/70">
                Complete overhaul of legacy e-commerce platform with modern payment integration.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-r from-secondary/10 via-primary/5 to-secondary/5 dark:bg-surface-dark">
            <CardHeader>
              <div className="bg-gradient-to-br from-secondary/20 to-primary/30 rounded-lg h-48 flex items-center justify-center mb-4">
                <div className="text-center text-white">
                  <div className="text-4xl font-bold mb-2">SaaS</div>
                  <div className="text-sm opacity-80">Dashboard Design</div>
                </div>
              </div>
              <Badge variant="outline" className="w-fit mb-2">
                SaaS Platform
              </Badge>
              <CardTitle className="dark:text-text-dark">Analytics Dashboard</CardTitle>
              <CardDescription className="dark:text-text-dark/70">
                Custom analytics platform with real-time data visualization and reporting.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" size="sm" asChild>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-primary/5 via-secondary/10 to-primary/3 dark:bg-surface-dark">
            <CardHeader>
              <div className="bg-gradient-to-br from-primary/20 to-secondary/30 rounded-lg h-48 flex items-center justify-center mb-4">
                <div className="text-center text-white">
                  <div className="text-4xl font-bold mb-2">CRM</div>
                  <div className="text-sm opacity-80">System Integration</div>
                </div>
              </div>
              <Badge variant="outline" className="w-fit mb-2">
                Business Systems
              </Badge>
              <CardTitle className="dark:text-text-dark">CRM Integration</CardTitle>
              <CardDescription className="dark:text-text-dark/70">
                Seamless integration of customer relationship management with existing workflows.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" size="sm" asChild>
